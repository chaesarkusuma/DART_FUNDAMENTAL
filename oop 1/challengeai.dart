...
class Character {
  ...
  void attack(Character target) {
    print('$name menyerang ${target.name} dengan $power damage');
    target.health -= power; // nyawa target berkurang
  ...
  void heal() {
    health += 10;
    print('$name heal, health sekarang $health');
  }
}

// Warrior adalah turunan dari Character
